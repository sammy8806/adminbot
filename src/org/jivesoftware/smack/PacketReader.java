 ...
 * $RCSfile$
 * $Revision: 11616 $
 * $Date: 2010-02-09 13:40:11 +0100 (Di, 09 Feb 2010) $
 *
...
class PacketReader {
    ...
    public void shutdown() {
        ...
        if (!done) {
            for (ConnectionListener listener : connection.getConnectionListeners()) {
                try {
                    ...
                    // from a faulty manager and finish the shutdown process
                    e.printStackTrace();
                }
            }
        }
        ...
        // Shut down the manager executor.
    ...
    private void processPacket(Packet packet) {
        ...
        // System.out.println("PacketReader :: "+packet.toString());
    ...
    private void parseFeatures(XmlPullParser parser) throws Exception {
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                if (eventType == XmlPullParser.START_TAG && errorCode == null) {
                    errorCode = parser.getName();
                } else if (eventType == XmlPullParser.START_TAG && parser.getName().equals("text")) {
                    text = parser.nextText();
                    if(errorCode == null)
                        new StreamError(errorCode, text);
                }
