...
public abstract class Connection {
    ...
    /**
     * Adds a new manager that will be notified when new Connections are created. Note
     * that newly created connections will not be actually connected to the server.
     * 
     * @param connectionCreationListener a manager interested on new connections.
     */
    ...
    /**
     * Removes a manager that was interested in connection creation events.
     * 
     * @param connectionCreationListener a manager interested on new connections.
     */
    ...
    /**
     * Adds a connection manager to this connection that will be notified when
     ...
     * 
     * @param connectionListener a connection manager.
     */
    ...
    /**
     * Removes a connection manager from this connection.
     * 
     * @param connectionListener a connection manager.
     */
    ...
    /**
     * Registers a packet manager with this connection. A packet filter determines
     * which packets will be delivered to the manager. If the same packet manager
     * is added again with a different filter, only the new filter will be used.
     * 
     * @param packetListener the packet manager to notify of new received packets.
     * @param packetFilter   the packet filter to use.
     */
    public void addPacketListener(PacketListener packetListener, PacketFilter packetFilter) {
        if (packetListener == null) {
            throw new NullPointerException("Packet manager is null.");
        }
    ...
    /**
     * Removes a packet manager for received packets from this connection.
     * 
    ...
    /**
     * A wrapper class to associate a packet filter with a manager.
     */
    protected static class ListenerWrapper {
        ...
        /**
         * Create a class which associates a packet filter with a manager.
         * 
         * @param packetListener the packet manager.
        ...
        /**
         * Notify and process the packet manager if the filter matches the packet.
         * 
