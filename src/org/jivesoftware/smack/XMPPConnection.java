 ...
 * $RCSfile$
 * $Revision: 12540 $
 * $Date: 2011-06-23 21:55:10 +0200 (Do, 23 Jun 2011) $
 *
...
public class XMPPConnection extends Connection {
    ...
    /**
     * Registers a packet manager with this connection. The manager will be
     * notified of every packet that this connection sends. A packet filter determines
     * which packets will be delivered to the manager. Note that the thread
     * that writes packets will be used to invoke the listeners. Therefore, each
     * packet manager should complete all operations quickly or use a different
     * thread for processing.
     *
     * @param packetListener the packet manager to notify of sent packets.
     * @param packetFilter   the packet filter to use.
    ...
    /**
     * Removes a packet manager for sending packets from this connection.
     *
     * @param packetListener the packet manager to remove.
    ...
    private void connectUsingConfiguration(ConnectionConfiguration config) throws XMPPException {
        ...
        try {
            ...
            String errorMessage = "Could not enable SSL encryption while connecting to " + host + ":"
                    + port + ".";
            throw new XMPPException(errorMessage, new XMPPError(
