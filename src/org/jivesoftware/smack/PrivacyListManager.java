...
public class PrivacyListManager {
    ...
    static {
        ...
        // method of PrivacyListManager, we'll add a manager that will delete the
    ...
    private void init() {
        ...
        // Add a manager to the connection that removes the registered instance when
    ...
    /**
     * Adds a packet manager that will be notified of any new update in the user
     * privacy communication.
     *
     * @param listener a packet manager.
     */
    public void addListener(PrivacyListListener listener) {
        // Keep track of the manager so that we can manually deliver extra
