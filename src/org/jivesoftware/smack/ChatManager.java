 ...
 * made aware of new chats, register a manager by calling {@link #addChatListener(ChatManagerListener)}.
 *
...
public class ChatManager {
    ...
    ChatManager(Connection connection) {
        ...
        // Add a manager for all message packets so that we can deliver errant
     ...
     * @param listener the manager which will listen for new messages from this chat.
     ...
     * @param listener the manager to add to the chat
     * @return the created chat.
     */
    ...
    /**
     * Register a new manager with the ChatManager to recieve events related to chats.
     *
     * @param listener the manager.
     */
    ...
    /**
     * Removes a manager, it will no longer be notified of new events related to chats.
     *
     * @param listener the manager that is being removed
     */
