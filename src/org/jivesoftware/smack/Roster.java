 ...
 * $RCSfile$
 * $Revision: 12370 $
 * $Date: 2011-05-12 04:06:35 +0200 (Do, 12 Mai 2011) $
 *
...
public class Roster {
    ...
    Roster(final Connection connection) {
        ...
        // if not connected add manager after successful login
    ...
    /**
     * Adds a manager to this roster. The manager will be fired anytime one or more
     * changes to the roster are pushed from the server.
     *
     * @param rosterListener a roster manager.
     */
    ...
    /**
     * Removes a manager from this roster. The manager will be fired anytime one or more
     * changes to the roster are pushed from the server.
     *
     * @param rosterListener a roster manager.
     */
    ...
    public enum SubscriptionMode {
         ...
         * processed by registering a manager for presence packets and then looking
