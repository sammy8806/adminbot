...
public class RosterExchangeManager {
    ...
    /**
     * Adds a manager to roster exchanges. The manager will be fired anytime roster entries
     * are received from remote XMPP clients.
     *
     * @param rosterExchangeListener a roster exchange manager.
     */
    ...
    /**
     * Removes a manager from roster exchanges. The manager will be fired anytime roster
