 ...
 * $RCSfile$
 * $Revision: 11613 $
 * $Date: 2010-02-09 12:55:56 +0100 (Di, 09 Feb 2010) $
 *
...
public class MultiUserChat {
    ...
    /**
     * Adds a manager to invitation notifications. The manager will be fired anytime
     * an invitation is received.
     *
     * @param conn the connection where the manager will be applied.
     * @param listener an invitation manager.
     */
    ...
    /**
     * Removes a manager to invitation notifications. The manager will be fired anytime
     * an invitation is received.
     *
     * @param conn the connection where the manager was applied.
     * @param listener an invitation manager.
     */
    ...
    /**
     * Adds a manager to invitation rejections notifications. The manager will be fired anytime
     * an invitation is declined.
     *
     * @param listener an invitation rejection manager.
     */
    ...
    /**
     * Removes a manager from invitation rejections notifications. The manager will be fired
    ...
    /**
     * Adds a manager to subject change notifications. The manager will be fired anytime
     * the room's subject changes.
     *
     * @param listener a subject updated manager.
     */
    ...
    /**
     * Removes a manager from subject change notifications. The manager will be fired
     ...
     *
     * To be notified every time the room's subject change you should add a manager
    ...
    /**
     * Adds a packet manager that will be notified of any new Presence packets
     * sent to the group chat. Using a manager is a suitable way to know when the list
     * of occupants should be re-loaded due to any changes.
     *
     * @param listener a packet manager that will be notified of any presence packets
    ...
    /**
     * Remoces a packet manager that was being notified of any new Presence packets
     * sent to the group chat.
     *
     * @param listener a packet manager that was being notified of any presence packets
     *      sent to the group chat.
     */
     ...
     * @param listener the manager is a message manager that will handle messages for the newly
     * created chat.
    ...
    */
    ...
    /**
     * Adds a packet manager that will be notified of any new messages in the
     * group chat. Only "group chat" messages addressed to this group chat will
     * be delivered to the manager. If you wish to listen for other packets
     * that may be associated with this group chat, you should register a
     * PacketListener directly with the Connection with the appropriate
     * PacketListener.
     *
     * @param listener a packet manager.
     */
    ...
    /**
     * Removes a packet manager that was being notified of any new messages in the
     * multi user chat. Only "group chat" messages addressed to this multi user chat were
     * being delivered to the manager.
     *
     * @param listener a packet manager.
     */
    ...
    /**
     * Adds a manager that will be notified of changes in your status in the room
     * such as the user being kicked, banned, or granted admin permissions.
     *
     * @param listener a user status manager.
     */
    ...
    /**
     * Removes a manager that was being notified of changes in your status in the room
     * such as the user being kicked, banned, or granted admin permissions.
     *
     * @param listener a user status manager.
     */
    ...
    /**
     * Adds a manager that will be notified of changes in occupants status in the room
     * such as the user being kicked, banned, or granted admin permissions.
     *
     * @param listener a participant status manager.
     */
    ...
    /**
     * Removes a manager that was being notified of changes in occupants status in the room
     * such as the user being kicked, banned, or granted admin permissions.
     *
     * @param listener a participant status manager.
     */
    ...
    private void init() {
        ...
        // Create a manager for subject updates.
        ...
        // Create a manager for all presence updates.
    ...
    private static class InvitationsMonitor implements ConnectionListener {
         ...
         *
         * If this is the first monitor's manager then the monitor will be initialized in
        ...
        public void addInvitationListener(InvitationListener listener) {
            synchronized (invitationsListeners) {
                // If this is the first monitor's manager then initialize the listeners
         ...
         * be stopped. As soon as a new manager is added to the monitor, the monitor will resume
        ...
        private void init() {
            ...
            // Add a manager to detect when the connection gets closed in order to
