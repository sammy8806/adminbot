...
class PacketMultiplexListener implements PacketListener {
    ...
    public PacketMultiplexListener(
        ...
        if (presenceListener == null) {
            throw new IllegalArgumentException("Presence manager is null");
        }
        if (subjectListener == null) {
            throw new IllegalArgumentException("Subject manager is null");
        }
        if (declinesListener == null) {
            throw new IllegalArgumentException("Declines manager is null");
        }
