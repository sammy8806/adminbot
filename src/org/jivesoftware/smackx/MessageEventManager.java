...
public class MessageEventManager {
    ...
    /**
     * Adds a message event request manager. The manager will be fired anytime a request for
     * event notification is received.
     *
     * @param messageEventRequestListener a message event request manager.
     */
    ...
    /**
     * Removes a message event request manager. The manager will be fired anytime a request for
     * event notification is received.
     *
     * @param messageEventRequestListener a message event request manager.
     */
    ...
    /**
     * Adds a message event notification manager. The manager will be fired anytime a notification
     * event is received.
     *
     * @param messageEventNotificationListener a message event notification manager.
     */
    ...
    /**
     * Removes a message event notification manager. The manager will be fired anytime a notification
     * event is received.
     *
     * @param messageEventNotificationListener a message event notification manager.
     */
