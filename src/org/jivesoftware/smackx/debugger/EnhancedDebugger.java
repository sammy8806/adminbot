 ...
 * $RCSfile$
 * $Revision: 12914 $
 * $Date: 2011-12-16 14:39:24 +0100 (Fr, 16 Dez 2011) $
 *
...
public class EnhancedDebugger implements SmackDebugger {
    ...
    private void addBasicPanels() {
        ...
        // Create a table manager that listen for row selection events
        ...
        menu.add(menuItem1);
        // Add manager to the text area so the popup menu can come up.
    ...
    public void userHasLogged(final String user) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                // Add the connection manager to the connection so that the debugger can be notified
    ...
    /**
     * Stops debugging the connection. Removes any manager on the connection.
     */
    void cancel() {
