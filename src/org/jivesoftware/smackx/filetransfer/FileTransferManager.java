 ...
 * <p>
 * And to recieve a file add a file transfer manager to the manager. The
 * manager will notify you when there is a new file transfer request. To create
...
public class FileTransferManager {
	...
	/**
	 * Add a file transfer manager to listen to incoming file transfer
	 * requests.
	 * 
	 * @param li
	 *            The manager
	...
	/**
	 * Removes a file transfer manager.
	 * 
	 * @param li
	 *            The file transfer manager to be removed
	 * @see FileTransferListener
	 */
