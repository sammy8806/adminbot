...
/**
 * Defines the manager for item deletion events from a node.
 * 
...
{
	/**
	 * Called when items are deleted from a node the manager is
	 * registered with.
	 * 
	...
	/**
	 * Called when <b>all</b> items are deleted from a node the manager is
	 * registered with. 
	 */
	void handlePurge();
}
