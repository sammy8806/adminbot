...
abstract public class Node
{
	...
	/**
	 * Register a manager for item publication events.  This
	 * manager will get called whenever an item is published to
	 * this node.
	 * 
	...
	/**
	 * Unregister a manager for publication events.
	 * 
	...
	/**
	 * Register a manager for configuration events.  This manager
	...
	/**
	 * Unregister a manager for configuration events.
	 * 
	 * @param listener The handler to unregister
	 */
	...
	/**
	 * Register an manager for item delete events.  This manager
	...
	/**
	 * Unregister a manager for item delete events.
	 * 
	 * @param listener The handler to unregister
	 */
