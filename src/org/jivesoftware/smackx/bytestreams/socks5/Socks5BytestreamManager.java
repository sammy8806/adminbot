 ...
 * SOCKS5 Bytestreams from a specific user add the manager by invoking
...
public final class Socks5BytestreamManager implements BytestreamManager {
    ...
    /*
     * create a new Socks5BytestreamManager and register a shutdown manager on every established
     * connection
     */
    static {
    ...
    /*
     * assigns a user to a manager that is informed if a bytestream request for this user is
     * received
     */
    ...
    /* manager that handles all incoming bytestream requests */
    ...
    /**
     * Removes the given manager from the list of listeners for all incoming SOCKS5 Bytestream
     * requests.
     * 
     ...
     * service discovery, disabling the manager for SOCKS5 Bytestream initiation requests and
    ...
    public synchronized void disableService() {
        ...
        // remove initiation packet manager
     ...
     * manager and enabling the SOCKS5 Bytestream feature.
     */
    private void activate() {
        // register bytestream initiation packet manager
