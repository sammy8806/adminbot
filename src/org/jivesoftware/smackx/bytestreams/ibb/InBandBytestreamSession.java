...
public class InBandBytestreamSession implements BytestreamSession {
     ...
     * Subclasses of this input stream must provide a packet manager along with a packet filter to
     * collect the In-Band Bytestream data packets.
     */
    private abstract class IBBInputStream extends InputStream {

        /* the data packet manager to fill the data queue */
        ...
        public IBBInputStream() {
            // add data packet manager to connection
            this.dataPacketListener = getDataPacketListener();
            connection.addPacketListener(this.dataPacketListener, getDataPacketFilter());
        }

        /**
         * Returns the packet manager that processes In-Band Bytestream data packets.
         * 
         * @return the data packet manager
         */
        ...
        /**
         * This method sets the close flag and removes the data packet manager.
         */
