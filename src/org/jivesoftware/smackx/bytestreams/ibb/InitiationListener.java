...
class InitiationListener implements PacketListener {
    ...
    private void processRequest(Packet packet) {
        ...
        if (userListener != null) {
            ...
            /*
             * if there is no user specific manager inform listeners for all initiation requests
             */
            ...
            /*
             * if there is no manager for this initiation request, reply with reject message
             */
