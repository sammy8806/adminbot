 ...
 * manager. There are two ways to add this manager. If you want to be informed about incoming
 * In-Band Bytestreams from a specific user add the manager by invoking
 * {@link #addIncomingBytestreamListener(BytestreamListener, String)}. If the manager should
...
public class InBandBytestreamManager implements BytestreamManager {
    ...
    /*
     * create a new InBandBytestreamManager and register its shutdown manager on every established
     * connection
     */
    static {
    ...
    /*
     * assigns a user to a manager that is informed if an In-Band Bytestream request for this user
     * is received
     */
    ...
    /* manager that handles all incoming In-Band Bytestream requests */
    private final InitiationListener initiationListener;

    /* manager that handles all incoming In-Band Bytestream IQ data packets */
    private final DataListener dataListener;

    /* manager that handles all incoming In-Band Bytestream close requests */
     ...
     * {@link FileTransferManager})
     * 
     * @param listener the manager to register
     */
    ...
    /**
     * Removes the given manager from the list of listeners for all incoming In-Band Bytestream
     * requests.
     * 
     * @param listener the manager to remove
     */
    ...
    /**
     * Removes the manager for the given user.
     * 
     * @param initiatorJID the JID of the user the manager should be removed
     */
