...
public class AdHocCommandManager {
    ...
    /**
     * Register the manager for all the connection creations. When a new
    ...
    private void init() {
        ...
        // Add a manager to the connection that removes the registered instance
        ...
        // The packet manager and the filter for processing some AdHoc Commands
        // Packets
