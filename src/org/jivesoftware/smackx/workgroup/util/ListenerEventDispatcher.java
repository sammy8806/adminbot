...
public class ListenerEventDispatcher
    ...
    /**
     * Add a manager triplet - the instance of the manager to be messaged, the Method on which
     *  the manager should be messaged, and the Object array of arguments to be supplied to the
     ...
     *
     * @param listenerInstance the instance of the manager to receive the associated notification
