...
public class Workgroup {
    ...
    public Workgroup(String workgroupJID, Connection connection) {
        ...
        // Register as a queue manager for internal usage by this instance.
        ...
        // Register a packet manager for all the messages sent to this client.
    ...
    /**
     * Adds a queue manager that will be notified of queue events for the user
     * that created this Workgroup instance.
     *
     * @param queueListener the queue manager.
     */
    ...
    /**
     * Adds an invitation manager that will be notified of groupchat invitations
     * from the workgroup for the the user that created this Workgroup instance.
     *
     * @param invitationListener the invitation manager.
     */
